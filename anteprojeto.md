...
Romañach e Lobato (2005) concordam com os termos "diversidade" e "funcional" no sentido de homens e mulheres que "funcionam", (atuam, realizam atividades, interagem, se relacionam...), também que há grupo na sociedade com funcionamentos distintos e sendo mais específico todo indivíduo também é.
...
- Mostrar de forma ampla todos os grupos de diferenças que podem ser assistidos pela acessibilidade no acesso da interface de uma aplicação. Trazer alguns exemplos de situações, algumas corriqueiras, da necessidade de acessibilidade.
- Apresentar as normatizações criadas para acessibilidade e referenciar a necessidades apresentadas no estudo já feito.
- Exemplificar com uma análise, de uma aplicação já criada, do que falta ser implementado e o que pode ser melhorado. Criar uma lista dessas necessidades.
